                ...
                <div id="right">
                    ...
                    <div class="text">
                       <form id="form1" method="post" action="">
                         <div align="left">
                           <p>&nbsp;</p>
                           <table width="368" border="1" bordercolor="#000000" >
                             <tr>
                               <td width="163">Full Name </td>
                               <td width="189"><label>
                                 <input name="name" type="text" id="name" style="border: thin solid #800000" />
                               </label></td>
                             </tr>
                             <tr>
                               <td>Username</td>
                               <td><input name="username" type="text" id="username" style="border: thin solid #800000"/></td>
                             </tr>
							 <td>Password</td>
                              <td>
                                <input name="password" type="text" id="password" style="border: thin solid #800000"/>
                              </td>
								<tr>
                               <td>Email</td>
                               <td><p>
                                 <input name="email" type="text" id="email" style="border: thin solid #800000" />
                               </p>
							   <p><?php echo $msg;?></p>
                                 <p>&nbsp; </p></td>
                             </tr>
